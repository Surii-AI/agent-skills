...
5. Run a targeted command only when the recorded evidence leaves a material doubt. Do not repeat passing suites merely for ceremony. Use the Code locator section's tool for any code lookup rather than crawling the repository.
