...
3. When the Code locator section names a tool, use it before grep/find to locate the code and the call paths it returns — a crawl re-derives what one query answers.
